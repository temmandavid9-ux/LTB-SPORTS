    ...
    >
      ...
      >
            <div className="bg-red-600 p-8 text-center relative">
              ...
              <h2 className="text-2xl font-black tracking-tight">Welcome to LTB LIVE SPORTS!</h2>
            ...
            <div className="p-8 space-y-6">
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <div className="bg-slate-800 p-3 rounded-2xl border border-slate-700 text-red-500">
                    <Zap size={24} />
                  </div>
                  <div>
