  ...
  return (
    ...
    >
      ...
      >
            ...
            <div className="w-full md:w-64 bg-slate-950 p-4 md:p-6 flex flex-row md:flex-col gap-2 border-b md:border-b-0 md:border-r border-slate-800 overflow-x-auto md:overflow-x-visible scrollbar-hide shrink-0">
              ...
              <div className="mt-auto pt-6 border-t border-slate-800">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 text-red-500 hover:text-red-400 transition-colors py-4 md:py-2 font-bold text-sm"
                >
                  <X size={16} /> Logout
                </button>
              </div>
            ...
            {/* Content Area */}
            <div className="flex-1 p-6 md:p-8 overflow-y-auto bg-slate-900 relative flex flex-col">
              ...
              {activeTab === 'profile' && (
                <div className="space-y-8">
                  ...
                  <button
                    onClick={handleSave}
                    className="w-full bg-red-600 hover:bg-red-700 py-4 rounded-2xl font-black text-lg tracking-tight transition-all shadow-lg hover:shadow-red-600/20 flex items-center justify-center gap-2 text-white"
                  >
                  ...
                  <button
                    ...
                    className="md:hidden w-full flex items-center justify-center gap-2 text-red-500 hover:text-red-400 transition-colors py-4 font-bold text-sm border-t border-slate-800 mt-4"
                  >
                    <X size={16} /> Logout
                  </button>
                </div>
